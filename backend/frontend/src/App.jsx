...
const App = () => {
    ...
    return (
        <Routes>
            ...
            <Route path="/employeesDetails" element={<ProtectedRoute element={<EmployeesList />} />} />
            <Route path="/createEmployee" element={<ProtectedRoute element={<CreateEmployee />} />} />
            <Route path="/updateEmployee/:id" element={<ProtectedRoute element={<UpdateEmployee />} />} />
            <Route path="/payroll/:id" element={<ProtectedRoute element={<PayrollList />} />} />
            <Route path="/createPayroll/:id" element={<ProtectedRoute element={<CreatePayroll />} />} />
            <Route path="/updatePayroll/:id" element={<ProtectedRoute element={<UpdatePayroll />} />} />
            <Route path="/attendence/:id" element={<ProtectedRoute element={<ReadAttendance />} />} />
            <Route path="/createAttendance/:id" element={<ProtectedRoute element={<CreateAttendence />} />} />
            <Route path="/updateAttendance/:id" element={<ProtectedRoute element={<UpdateAttendence />} />} />
        </Routes>
    );
};
