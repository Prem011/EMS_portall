...
const { updatePayroll, readpayroll, deletePayroll, createPayroll, getSinglePayroll, getSalaryForPayroll } = require('../controllers/payrollController');
...
router.get('/getSalaryOfAEmployee/:employeeId', isLoggedIn ,getSalaryForPayroll);
